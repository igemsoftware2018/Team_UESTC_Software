<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:88:"D:\Apache24\htdocs\DataBase\THINKPHP\public/../application/index\view\search\by_key.html";i:1539409003;s:76:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\base.html";i:1534298764;s:76:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\meta.html";i:1536997341;s:78:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\header.html";i:1539426028;s:76:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\foot.html";i:1536249134;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
        ...
        <div id="body-l" class="col-md-3 col-md-offset-1">
            <ul>
               <a href="by_id">
                ...
                <a href="by_key">
                    <li><span style="font-size: 18px" class="label label-primary">Team wiki</span>
                        <hr>
                    </li>
                </a>
                <a href="by_function">
        ...
        <div id="body-r" class='col-md-5 col-md-offset-1 col-sm-8 col-sm-offset-2'>
            <div id="body-r-con">
                ...
                <form method="post" action="<?php echo url('index/search/submitTwo'); ?>" style="position: relative;top: 30px;">
                    ...
                    <div id="bd-2">
                        <p>Keywords :</p>
                        <textarea id="x1" name="keys" clos=",50" rows="5" warp="virtual" class="col-md-9 col-sm-9" style="height: 80px" required title='Please fill in this field' oninvalid="setCustomValidity('keywords are required');" oninput="setCustomValidity('');"></textarea>
                    </div>

                    <div id="exp" style="position: relative">
                        <p style="display: inline;color: #666666">Example:</p>
                        <p onclick="exa()" id="exa" style="color:#666666;cursor: pointer;display: inline">biosensor
                        </p>
                        <p onclick="exa_1()" id="exa_1" style="color:#666666;cursor: pointer;position: absolute;">biosensor and Aflatoxin
                        </p>
                    </div>
                    <div id="bd_2-2">
