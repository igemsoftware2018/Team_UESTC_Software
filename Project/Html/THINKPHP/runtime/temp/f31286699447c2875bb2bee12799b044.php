<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:89:"D:\Apache24\htdocs\数据库\THINKPHP\public/../application/index\view\search\by_seq.html";i:1534916256;s:77:"D:\Apache24\htdocs\数据库\THINKPHP\application\index\view\public\base.html";i:1534298764;s:77:"D:\Apache24\htdocs\数据库\THINKPHP\application\index\view\public\meta.html";i:1534727951;s:79:"D:\Apache24\htdocs\数据库\THINKPHP\application\index\view\public\header.html";i:1534917482;s:77:"D:\Apache24\htdocs\数据库\THINKPHP\application\index\view\public\foot.html";i:1534136683;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body>
    ...
    <div id="body" class="container" >
        <div class="row">
            <div id="body-l" class="col-md-3 col-md-offset-1">
                <ul>
                    <li><a href="by_func">Search by function</a>
                        <hr>
                    </li>
                    <li><a href="by_seq">Search by Sequence</a>
                        <hr>
                    </li>
            ...
            <div id="body-r" class='col-md-5 col-md-offset-1 col-sm-8 col-sm-offset-2'>
                <div id="body-r-con">
                    ...
                    <form>
                        <div id="bd-2">
                        <p>Sequence :</p>
                        <textarea id="x1" clos=",50" rows="5" warp="virtual" class="col-md-9 col-sm-9" style="height: 80px"></textarea>

                    </div>
                    <div id="bd_1-2">
                        <p>Submit Team:</p>
                        <select id="x2" name="epd" class="col-md-9 col-sm-9" style="height: 35px">

  <option>---------please choose one--------</option>

  <option value="epd">...</option>
  ...
  <option value="option3">...</option>
                    ...
                    <div id="bd_2-2">
                        ...
                        <input type="button" id="submit" class="col-md-6 col-sm-6" style="height: 35px" value="Submit">
                    </div>
                    </form>
