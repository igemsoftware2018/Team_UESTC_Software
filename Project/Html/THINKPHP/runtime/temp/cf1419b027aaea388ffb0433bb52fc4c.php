<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:100:"D:\Apache24\htdocs\DataBase\THINKPHP\public/../application/index\view\display\displayer_protein.html";i:1538115119;s:76:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\base.html";i:1534298764;s:76:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\meta.html";i:1536997341;s:78:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\header.html";i:1537498204;s:76:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\foot.html";i:1536249134;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="row">
            <nav id="clu">
                <ul class="nav">
                    ...
                    <li class="active"><a href="#pro">Protein domains</a></li><hr>
            ...
            <div class="col-lg-10 col-md-10 col-sm-9 col-lg-offset-2 col-md-offset-2 col-sm-offset-3 con-r-1">
                ...
                <div class="title_1">
                <span><?php echo $res_7_0['iGEM_ID']; ?></span>
                <p>Protein domains</p></div>
                <div id="pro" class="hz">
                    ...
                    <table class="table table-bordered" style="border: solid 2px #ffee99;box-shadow: inset 0 0 10px #CCC;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-2"><?php echo $res_7_0['Description']; ?></td>
                            </tr>
                            
                            <tr>
                                <th>Submit_team</th>
                                <td><a href="http://<?php echo substr($res_7_0['Submit_team'],0,4)?>.igem.org/Team:<?php echo substr($res_7_0['Submit_team'],5)?>"><?php echo $res_7_0['Submit_team']; ?></a></td>
                            </tr>
                            
                            
                            <tr>
                                <th>Sample_Statu</th>
                                <td><?php echo $res_7_0['Sample_Statu']; ?></td>
                            </tr>
                            <tr>
                                <th>Uses</th>
                                <td><?php echo $res_7_0['Uses']; ?></td>
                            </tr>
                            <tr>
                                <th>Twin</th>
                                <td><?php echo $res_7_0['Twin']; ?></td>
                            </tr>
                            <tr>
                                <th>Nickname</th>
                                <td><?php echo $res_7_0['Nickname']; ?></td>
                            </tr>
                            <tr>
                                <th>Designer</th>
                                <td><?php echo $res_7_0['Designer']; ?></td>
                            </tr>
                            <tr>
                                <th>Categories</th>
                                <td><?php echo $res_7_0['Categories']; ?></td>
                            </tr>
                            <tr>
                                <th>Assembly Compatibility</th>
                                <td><?php echo $res_7_0['Green']; ?></td>
                            </tr>
                            <tr>
                                <th>Sequence</th>
                                <?php if(strlen($res_7_0['sequence']) >300): ?>
                                <td title="<?php echo $res_7_0['sequence']; ?>">
                                    <?php echo substr($res_7_0['sequence'],0,300); ?>...<span style="font-size: 15px;color:#ffee99">(mouseover to show all)</span></td>
                                <?php else: ?>
                                <td><?php echo $res_7_0['sequence']; ?></td>
                                <?php endif; ?>
                            </tr>
                            
                            <tr>
                                <th>iGEM_Link</th>
                                <td><a href="<?php echo $res_7_0['iGEM_Link']; ?>"><?php echo $res_7_0['iGEM_Link']; ?></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<!--                                <td><a href="#">SBOL</a></td>-->
                             ...
                             <tr>
                                <td><a href="http://localhost:12345/DataBase/THINKPHP/public/testfile/<?php echo $filename_7; ?>">FASTA</a></td>
                            </tr>
                             <tr>
