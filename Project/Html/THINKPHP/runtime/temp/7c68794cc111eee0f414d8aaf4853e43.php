<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:93:"D:\Apache24\htdocs\DataBase\THINKPHP\public/../application/index\view\display\func_brick.html";i:1537521712;s:76:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\base.html";i:1534298764;s:76:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\meta.html";i:1536997341;s:78:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\header.html";i:1539426028;s:76:"D:\Apache24\htdocs\DataBase\THINKPHP\application\index\view\public\foot.html";i:1536249134;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="container" style="position: relative;top: 100px">
    <div class="row">
        <div class="col-md-2 col-md-offset-1 ">
            <a href="<?php echo url('index/Search/by_function'); ?>">
    ...
    <div class="row">
        ...
        <div class="col-md-2 col-md-offset-6 col-sm-2 col-sm-offset-5" style="position: relative;top:30px;height: 50px;line-height: 50px">
    ...
    <div class="row">
        <div class="col-md-11 col-md-offset-1" style="position: relative;top: 20px">
            <table class="table table-bordered table-striped" style="border: solid 2px #ffee99;box-shadow: inset 0 0 10px #CCC;">
                <tbody>
                    <?php if(is_array($bricks) || $bricks instanceof \think\Collection || $bricks instanceof \think\Paginator): $k = 0;$__LIST__ = is_array($bricks) ? array_slice($bricks,0,100, true) : $bricks->slice(0,100, true); if( count($__LIST__)==0 ) : echo "have no data" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                    <tr>
                        <td>iGEM_ID</td>
                        <td><a href="<?php echo url('index/display/displayer',array('id'=>$vo['iGEM_ID'])); ?>"><?php echo $vo['iGEM_ID']; ?></a></td>
                        <td><span style="font-size: 15px" class="label label-success"><?php echo $vo['type']; ?></span></td>
                    </tr>
