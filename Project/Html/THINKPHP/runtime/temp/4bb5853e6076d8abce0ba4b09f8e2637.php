<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:103:"D:\Apache24\htdocs\数据库\THINKPHP\public/../application/index\view\display\displayer_composite.html";i:1535176101;s:77:"D:\Apache24\htdocs\数据库\THINKPHP\application\index\view\public\base.html";i:1534298764;s:77:"D:\Apache24\htdocs\数据库\THINKPHP\application\index\view\public\meta.html";i:1534727951;s:79:"D:\Apache24\htdocs\数据库\THINKPHP\application\index\view\public\header.html";i:1534917482;s:77:"D:\Apache24\htdocs\数据库\THINKPHP\application\index\view\public\foot.html";i:1534136683;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-10 col-sm-9 col-lg-offset-2 col-md-offset-2 col-sm-offset-3 con-r-1">
                ...
                <div id="Composite_Parts" class="hz">
                    ...
                    <table class="table table-bordered" style="border: solid 2px #ffee99;box-shadow: inset 0 0 10px #CCC;">
                        <tbody>
                            ...
                            <tr>
                                <th>Submit_team</th>
                                <td><a href="<?php echo url('index/display/team_1',array('t'=>$res_2_0['Submit_team'])); ?>"><?php echo $res_2_0['Submit_team']; ?></a></td>
                            </tr>

                            <tr>
                                <th>Sequence</th>
                                <?php if(strlen($res_2_0['sequence']) >500): ?>
                                <td title="<?php echo $res_2_0['sequence']; ?>">
                                    <?php echo substr($res_2_0['sequence'],0,500); ?>...<span style="font-size: 15px;color:cornsilk">(mouseover to show all)</span></td>
                                <?php else: ?>
                ...
                <div id="Component" class="hz">
                    ...
                    <table class="table table-bordered" style="border: solid 2px #ffee99;box-shadow: inset 0 0 10px #CCC;">
                        <tbody>
                            <?php if(is_array($res_2_1) || $res_2_1 instanceof \think\Collection || $res_2_1 instanceof \think\Paginator): $k = 0;$__LIST__ = is_array($res_2_1) ? array_slice($res_2_1,0,100, true) : $res_2_1->slice(0,100, true); if( count($__LIST__)==0 ) : echo "Have no data" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                            <tr>
